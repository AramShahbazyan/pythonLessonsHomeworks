...
if num_2 % num_1 == 0:
    ...
    print('the balance after division: '), print(num_2 % num_1) # ես կարծում եմ ճիշտ կլինի print('the balance after division: ՛,num_2 % num_1)
    print('the whole part after the division: '), print(num_2 // num_1) # print('the whole part after the division: ',num_2 // num_1)
